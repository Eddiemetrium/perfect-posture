  ...
  return (
    <footer className="pd-16 pt-10">
      <div className="container ">
        <div className="flex justify-between items-center flex-col md:flex-row flex-wrap gap-[30] ">
          <div>
          ...
          <div>
            <h2 className=" text-[20] leading-[30px] font-[700] mb-6 text-headingColor mx-auto">
              Quick Links
            </h2>
            <ul>
          ...
          <div>
            ...
            <ul>
              {quickLinks03.map((item, index) => (
                <li href={item.href} key={index} legacyBehavior>
                  <a className="text-[16px] leading-7 font-[400] text-textColor mx">
                    {item.display}
                  </a>
                </li>
              ))}
